...
public class ThreeReeler {
    ...
    public Symbol[] getReel1() {
        return getReel(reel1);
    }

    public Symbol[] getReel2() {
        return getReel(reel2);
    }

    public Symbol[] getReel3() {
        return getReel(reel3);
    }

    private static Symbol[] getReel(Reel reel) {
        return reel.getReel();
    }
